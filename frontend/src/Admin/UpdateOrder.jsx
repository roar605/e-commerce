...
function UpdateOrder() {
    ...
    useEffect(() => {
        ...
        if (success) {
            toast.error('Order status updated successfully', { position: "top-center", autoClose: 3000 });
            ...
            <div className="order-container">
                ...
                <div className="order-details">
                    ...
                    <p><strong>Shipping Address : </strong>
                        {shippingInfo.address}, {shippingInfo.city},{shippingInfo.state},{shippingInfo.country} - {shippingInfo.pinCode}</p>
                ...
                <div className="order-status">
                    <h2>Update Status</h2>
                    <select className="status-select" value={status} onChange={
