        ...
        <>
            ...
            <div className="update-product-wrapper">
                ...
                <form className="update-product-form" encType='multipart/form-data' onSubmit={updateProductSubmit}>
                    ...
                    <input type="text" className="update-product-input" required
                        id='name' name='name'
                        value={name} onChange={(e) => setName(e.target.value)} />

                    <label htmlFor="price">Product Price</label>
                    <input type="number" className="update-product-input" required
                        id='price' name='price'
                        value={price} onChange={(e) => setPrice(e.target.value)} />

                    <label htmlFor="description">Product Description</label>
                    <textarea type="text" className="update-product-textarea" required
                        id='description' name='description'
                        value={description} onChange={(e) => setDescription(e.target.value)} />

                    <label htmlFor="category">Product Category</label>
                    <select name="category" id="category" className="update-product-select"
                        value={category} onChange={(e) => setCategory(e.target.value)}>
                        <option value="">Choose a Catehory</option>
                    ...
                    <div className="update-product-file-wrapper">
                        <input type="file" accept='image/' name='image' multiple className='update-product-file-input'
                    ...
                    <div className="update-product-old-images-wrapper">
                        {oldImage.map((img, index) => (< img src={img.url} key={index} alt="Old Product Preview"
